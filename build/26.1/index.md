...
![A Camel is laying in a Desert Village. There's a Villager next to it.](https://launchercontent.mojang.com/v2/images/2619.jpg)
...
![A Dolphin is jumping out of the water in front of a sunset.](https://launchercontent.mojang.com/v2/images/2613.jpg)

## Fixed bugs in 26.1

-   [MC-13187](https://bugs.mojang.com/browse/MC-13187) Water in water cauldrons is not transparent
-   [MC-64087](https://bugs.mojang.com/browse/MC-64087) Revengeful zombies / Zombie reinforcements try to attack players in Creative mode
...
-   [MC-129886](https://bugs.mojang.com/browse/MC-129886) Trying to place a block below the bottom of the world does not give an error message
...
-   [MC-184432](https://bugs.mojang.com/browse/MC-184432) There is no warning when using bone meal on plants that try to grow above or below the world height limits
...
-   [MC-197497](https://bugs.mojang.com/browse/MC-197497) The block light transition from level 1 to 0 is not smooth when there is no sky light and Smooth Lighting is enabled
-   [MC-199559](https://bugs.mojang.com/browse/MC-199559) Light appears darker and orange when Night Vision is active
...
-   [MC-221510](https://bugs.mojang.com/browse/MC-221510) Dolphin would rather drown than get air when chasing items
-   [MC-222949](https://bugs.mojang.com/browse/MC-222949) You can use tridents enchanted with Riptide while riding entities
-   [MC-230139](https://bugs.mojang.com/browse/MC-230139) Typos in stonecutter recipe names
...
-   [MC-233911](https://bugs.mojang.com/browse/MC-233911) Sleeping in a bed and waking up no longer instantly sets the daytime sky
-   [MC-248092](https://bugs.mojang.com/browse/MC-248092) Untamed cats on lead despawn when attached to fence post
-   [MC-254785](https://bugs.mojang.com/browse/MC-254785) Bone meal is consumed when used on a bamboo stalk with a block above it
...
-   [MC-260148](https://bugs.mojang.com/browse/MC-260148) show\_notification only works for shaped crafting recipes
...
-   [MC-274238](https://bugs.mojang.com/browse/MC-274238) Persistent trader llamas can despawn when leashed to wandering traders
...
-   [MC-279187](https://bugs.mojang.com/browse/MC-279187) The "selectWorld.backupWarning.snapshot" string incorrectly pluralizes the word "corruption"
...
-   [MC-298745](https://bugs.mojang.com/browse/MC-298745) Unlocking new recipes or changing dimensions replaces the locator bar with the experience bar temporarily
...
-   [MC-300380](https://bugs.mojang.com/browse/MC-300380) Copper golems do not pathfind down blocks that are in between half a block and a block tall to a chest
-   [MC-300465](https://bugs.mojang.com/browse/MC-300465) Maps with the maximum number of markers cannot be placed in item frames
-   [MC-301003](https://bugs.mojang.com/browse/MC-301003) The bell part of bells worn on copper golems' "saddle" slot is not visible
-   [MC-301245](https://bugs.mojang.com/browse/MC-301245) Copper golem statues are displayed upside down in block displays
...
-   [MC-303684](https://bugs.mojang.com/browse/MC-303684) Hoglins can despawn when attached to leads
-   [MC-303685](https://bugs.mojang.com/browse/MC-303685) Zoglins can despawn when attached to leads
-   [MC-303692](https://bugs.mojang.com/browse/MC-303692) The debug overlay text has an indent when "Improved Transparency" is disabled
...
-   [MC-304705](https://bugs.mojang.com/browse/MC-304705) The E value in entity\_render\_stats in the debug overlay doesn't work
...
-   [MC-305451](https://bugs.mojang.com/browse/MC-305451) Tripwire is invisible through translucent blocks if "Improved Transparency" is disabled
...
-   [MC-306566](https://bugs.mojang.com/browse/MC-306566) The totem of undying screen effect now jitters while the game is frozen
-   [MC-306658](https://bugs.mojang.com/browse/MC-306658) Dolphins let themselves drown even with ample access to air
