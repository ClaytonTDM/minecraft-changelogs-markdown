...
-   [MC-54988](https://bugs.mojang.com/browse/MC-54988) World border "warning" effect is not shown when graphics setting is set to "Fast"
...
-   [MC-179383](https://bugs.mojang.com/browse/MC-179383) Leaves not culled with graphics set to Fast
-   [MC-188602](https://bugs.mojang.com/browse/MC-188602) In non-natural custom dimensions, if "bed\_works" is set to true, beds cannot be used to skip the night or set the spawn point
-   [MC-189837](https://bugs.mojang.com/browse/MC-189837) Nether fog is dark after rejoining a world that is thunder storming in the Overworld
...
-   [MC-241321](https://bugs.mojang.com/browse/MC-241321) Darkness vignette effect is not shown when graphics setting is set to "Fast"
-   [MC-245854](https://bugs.mojang.com/browse/MC-245854) Fast graphics description is slightly misleading
...
-   [MC-259368](https://bugs.mojang.com/browse/MC-259368) Z-fighting occurs on trimmed armor items
...
-   [MC-274828](https://bugs.mojang.com/browse/MC-274828) Horse armor item and entity model tint affects the entirety of the textures
...
-   [MC-277768](https://bugs.mojang.com/browse/MC-277768) Mipmapping no longer affects items
...
-   [MC-301756](https://bugs.mojang.com/browse/MC-301756) The “This is a Snapshot Realm…” box outline is rendered above the delete realm interface
...
-   [MC-302493](https://bugs.mojang.com/browse/MC-302493) The mouse cursor doesn't change to the hand shape when hovering over the close button in the "Add Realm" screen
